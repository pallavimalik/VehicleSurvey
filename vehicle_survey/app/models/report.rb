class Report
  ...
  def self.peak_volume_time_report(count_list)
    { morn_vs_eve_peak_time_per_day: { Northbound: calc_daily_peak_time(count_list[:vehicle_count_morn_vs_eve][:Northbound], MORN_VS_EVE_TIME_PERIOD), Southbound: calc_daily_peak_time(count_list[:vehicle_count_morn_vs_eve][:Southbound], MORN_VS_EVE_TIME_PERIOD) },
     hour_peak_time_per_day: { Northbound: calc_daily_peak_time(count_list[:vehicle_count_per_hr][:Northbound], PER_HR_TIME_PERIOD), Southbound: calc_daily_peak_time(count_list[:vehicle_count_per_hr][:Southbound], PER_HR_TIME_PERIOD) },
     half_hour_peak_time_per_day: { Northbound: calc_daily_peak_time(count_list[:vehicle_count_per_half_hr][:Northbound], PER_HALF_HR_TIME_PERIOD), Southbound: calc_daily_peak_time(count_list[:vehicle_count_per_half_hr][:Southbound], PER_HALF_HR_TIME_PERIOD) },
     twenty_min_peak_time_per_day: { Northbound: calc_daily_peak_time(count_list[:vehicle_count_per_twenty_min][:Northbound], PER_TWENTY_MIN_TIME_PERIOD), Southbound: calc_daily_peak_time(count_list[:vehicle_count_per_twenty_min][:Southbound], PER_TWENTY_MIN_TIME_PERIOD) },
     fifteen_min_peak_time_per_day: { Northbound: calc_daily_peak_time(count_list[:vehicle_count_per_fifteen_min][:Northbound], PER_FIFTEEN_MIN_TIME_PERIOD), Southbound: calc_daily_peak_time(count_list[:vehicle_count_per_fifteen_min][:Southbound], PER_FIFTEEN_MIN_TIME_PERIOD) } }
  end
